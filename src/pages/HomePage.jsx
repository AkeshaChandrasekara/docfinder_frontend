...
<section className="relative h-[64vh] bg-white overflow-hidden flex items-center border-b border-gray-100">
  <div className="container mx-auto px-6 relative z-10 h-full">
    <div className="flex flex-col md:flex-row items-center h-full">
      ...
      <motion.div 
        className="md:w-1/2 flex items-center justify-center h-full"
  ...
  <div className="container mx-auto px-6">
    ...
    >
      <h2 className="text-3xl font-bold text-gray-900 mb-4">How DocFinder Works</h2>
  ...
  {[
    ...
    <motion.div 
      ...
      viewport={{ once: true }}
      className="relative bg-white p-8 rounded-2xl overflow-hidden group text-center"
    >
      ...
      <div className="relative z-10 flex flex-col items-center">
        <div className="w-14 h-14 mb-6 rounded-xl bg-blue-600 flex items-center justify-center text-white shadow-md mx-auto">
          {step.icon}
        </div>
...
<section className="py-12 bg-white">
  <div className="container mx-auto px-6">
    <motion.div
      ...
      className="text-center mb-16"
    >
      <h2 className="text-3xl font-bold text-gray-900 mb-4">Browse By Speciality</h2>
      <div className="w-20 h-1 bg-blue-600 mx-auto mb-4"></div>
      <p className="text-gray-600 max-w-2xl mx-auto">
    ...
    <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6 max-w-6xl mx-auto">
      {[
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          whileHover={{ y: -5 }}
          className="bg-white p-6 rounded-lg shadow-sm hover:shadow-md transition-all duration-300 text-center cursor-pointer border border-gray-100"
        >
          <div className="w-14 h-14 mb-3 mx-auto flex items-center justify-center text-blue-600">
            {specialty.icon}
          </div>
          <h3 className="font-bold text-gray-900 mb-1">{specialty.name}</h3>
          <p className="text-sm text-gray-500">{specialty.doctors} doctors</p>
        </motion.div>
      ))}
    ...
    <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
      {testimonials.map((testimonial, index) => (
        <motion.div
          ...
          className="h-full"
        >
          <div className="bg-white p-8 rounded-xl shadow-sm h-full flex flex-col relative overflow-hidden group border border-gray-100 hover:border-blue-200 transition-colors duration-300">
            ...
            <div className="relative flex-grow mb-6">
              <svg 
                className="absolute -top-2 -left-2 w-6 h-6 text-blue-200 opacity-80" 
                fill="currentColor" 
                viewBox="0 0 20 20"
              >
                <path fillRule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-8-3a1 1 0 00-.867.5 1 1 0 11-1.731-1A3 3 0 0113 8a3.001 3.001 0 01-2 2.83V11a1 1 0 11-2 0v-1a1 1 0 011-1 1 1 0 100-2zm0 8a1 1 0 100-2 1 1 0 000 2z" clipRule="evenodd" />
              </svg>
              <p className="text-gray-600 pl-6">"{testimonial.quote}"</p>
            </div>
    ...
    >
      <div className="relative overflow-hidden rounded-2xl bg-white shadow-xl">
        ...
        <div className="absolute inset-0 z-0 opacity-10">
          <div className="absolute top-0 left-0 w-32 h-32 bg-blue-400 rounded-full -translate-x-1/2 -translate-y-1/2"></div>
          <div className="absolute bottom-0 right-0 w-48 h-48 bg-blue-300 rounded-full translate-x-1/2 translate-y-1/2"></div>
        </div>
          ...
          <div className="flex flex-col lg:flex-row items-center gap-8">
            ...
            <div className="lg:w-1/3 w-full">
              <div className="space-y-4">
                <Link
                  to="/doctors"
                  className="block w-full bg-blue-600 hover:bg-blue-700 text-white font-bold py-4 px-6 rounded-xl transition-all duration-300 shadow-md hover:shadow-lg text-center"
                >
                  Find a Doctor
                </Link>
                <Link
                  to="/specialities"
                  className="block w-full bg-white border-2 border-blue-600 hover:bg-blue-50 text-blue-600 font-bold py-4 px-6 rounded-xl transition-all duration-300 text-center"
                >
                  Browse Specialties
                </Link>
              </div>
          ...
          <div className="mt-8 pt-8 border-t border-gray-100 flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <div className="flex items-center space-x-4">
              {["hospital", "medical-center", "clinic"].map((icon, i) => (
                <div key={i} className="w-10 h-10 bg-blue-50 rounded-lg flex items-center justify-center">
