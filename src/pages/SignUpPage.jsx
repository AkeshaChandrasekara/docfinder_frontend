    ...
    <div className="flex h-screen w-full items-center justify-center bg-white p-4">
      ...
      >
        ...
        <div className="relative z-10">
          {/* Header with logo */}
          <motion.div 
            className="pt-6 px-8 text-center"  
          ...
          {/* Signup Form */}
          <div className="px-8 pb-6 pt-4">  {/* Reduced padding */}
            <motion.div
              className="space-y-3" 
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
            ...
            >
                ...
                <div className="flex-1">
                  ...
                  <div className="relative">
                    <input
                      ...
                      className="block w-full pl-3 pr-3 py-2 text-sm bg-white text-gray-800 border border-gray-200 rounded-lg transition duration-150 placeholder-gray-400 hover:border-gray-300"  
              ...
              >
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    className="block w-full pl-10 pr-3 py-2 text-sm bg-white text-gray-800 border border-gray-200 rounded-lg transition duration-150 placeholder-gray-400 hover:border-gray-300"  
              ...
              <motion.button
                onClick={signup}
                className="w-full py-2 px-4 bg-gradient-to-r from-blue-600 to-blue-500 text-white text-sm font-semibold rounded-lg hover:from-blue-700 hover:to-blue-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition duration-300 shadow-md relative overflow-hidden group mt-1"  
              ...
              <motion.button
                onClick={() => {googleLogin()}}
                className="w-full flex justify-center items-center py-2 px-4 border border-gray-200 text-sm rounded-lg hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition duration-150 relative overflow-hidden group"
                initial={{ y: 20, opacity: 0 }}
                animate={{ y: 0, opacity: 1 }}
