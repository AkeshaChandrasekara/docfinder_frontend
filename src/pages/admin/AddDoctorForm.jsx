...
export default function AddDoctorForm() {
    ...
    experience: "",
    bio: "",
    photo: "https://cdn-icons-png.flaticon.com/512/8815/8815112.png",
    hospital: "",
     chanellingCenter: "",
    availableDays: []
  });
...
const fetchChanellingCenters = async () => {
  try {
    ...
    if (response.data.success) {
      setChanellingCenters(response.data.data);
    } else {
      setChanellingCenters(response.data);
    }
  } catch (error) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      toast.error(err.response?.data?.message || err.message || "Failed to add doctor");
    } finally {
    ...
    <option key={specialty._id} value={specialty._id}>{specialty.name}</option>
              ...
              <div className="md:col-span-2">
                ...
                >
                  ...
                  {Array.isArray(chanellingCenters) && chanellingCenters.map(center => (
